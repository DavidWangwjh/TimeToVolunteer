...
export function OrganizationCard({
  ...
  return (
    <div className="h-full">
      <Card className="h-full gap-0 overflow-hidden border-slate-200 bg-white py-0 transition hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-md hover:shadow-slate-950/5 min-h-0">
